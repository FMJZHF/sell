...
import com.zhf.sell.config.WechatPayConfig;
...
import com.zhf.sell.utils.MathUtil;
...
//        log.info("【微信预支付】payRequest={}",JsonUtil.toJson(payRequest));
        PayResponse response = bestPayService.pay(payRequest);       //发起支付
